  ...
  return (
    <form onSubmit={handleWithdraw} className="space-y-4">
      ...
      <button
        ...
        className="w-full rounded-lg bg-blue-500 px-4 py-3 font-semibold text-white hover:bg-blue-600 disabled:bg-zinc-300 disabled:cursor-not-allowed"
      >
        {isPending ? "Confirming..." : isConfirming ? "Processing..." : isSuccess ? "Success!" : "Withdraw"}
      </button>
    </form>
  );
}